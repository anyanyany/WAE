...
\textbf{Dodatkowo zaimplementowany algorytm co 100 iteracji (czyli co 100 losowań nowego punktu sąsiadującego z najlepszym dotychczas znalezionym rozwiązaniem) zapisuje wartość funkcji celu dla najlepszego osobnika. Warunkiem stopu jest uzyskanie 50 obserwacji.}\\
...
\textbf{Do eksperymentów zostały wybrane wymiary: 2, 5, 10, 20 oraz funkcje: 1, 2, 7, 16, 23.} Poniższa tabela przedstawia wartości minimalne wybranych funkcji (realizujemy problem minimaizacji).\\
\begin{center}
\begin{tabular}{|r|r|}
  \hline 
...
\begin{lstlisting}[mathescape][language=R]
dimensions $\leftarrow$ c(2,5,10,20);
functions $\leftarrow$ c(1,2,7,16,23);
N $\leftarrow$ 10; 
